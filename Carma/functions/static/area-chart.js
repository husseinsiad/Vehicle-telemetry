...
//     var db = firebase.database();
//      var index=[];
// 	var tripDateRef=db.ref('/Users/CYFfFMSnffRuE9nJzbwogTza2523/TripData/Trip 04-04-2020 10:37:13'); 
//           tripDateRef.on('value',function(snap){
//             snap.forEach(function(childNodes){
//               console.log(childNodes.val().index);
//               index.push(childNodes.val().index);
//             })
...
//           pointHitRadius: 50,
//           pointBorderWidth: 2,
//           data: [100, 6000, 2000, 8000, 4000, 5900, 3000, 7900],
//         },
//         {
//             label: "RPM",
//           lineTension: 0.3,
//           backgroundColor: "rgba(2,117,216,0.2)",
//           borderColor: "rgba(232,117,216,1)",
//           pointRadius: 5,
//           pointBackgroundColor: "rgba(232,117,216,1)",
//           pointBorderColor: "rgba(255,255,255,0.8)",
//           pointHoverRadius: 5,
//           pointHoverBackgroundColor: "rgba(2,117,216,1)",
//           pointHitRadius: 50,
//           pointBorderWidth: 2,
//           data: [100, 3400, 1000, 6000, 3000, 7900, 2000, 4900],
//         },
//         {
//           label: "OutsideTemp",
//         lineTension: 0.3,
//         backgroundColor: "rgba(2,117,216,0.2)",
//         borderColor: "rgba(132,217,16,1)",
//         pointRadius: 5,
//         pointBackgroundColor: "rgba(132,217,16,1)",
//         pointBorderColor: "rgba(255,255,255,0.8)",
//         pointHoverRadius: 5,
//         pointHoverBackgroundColor: "rgba(2,117,216,1)",
//         pointHitRadius: 50,
//         pointBorderWidth: 2,
//         data: [100, 7400, 4000, 1000, 4000, 2900, 3000, 900],
//       },
//       {
//         label: "Throttle position%",
//       lineTension: 0.3,
//       backgroundColor: "rgba(2,117,216,0.2)",
//       borderColor: "rgba(998,17,16,1)",
//       pointRadius: 5,
//       pointBackgroundColor: "rgba(998,17,16,1)",
//       pointBorderColor: "rgba(255,255,255,0.8)",
//       pointHoverRadius: 5,
//       pointHoverBackgroundColor: "rgba(2,117,216,1)",
//       pointHitRadius: 50,
//       pointBorderWidth: 2,
//       data: [10, 2400, 8000, 4000, 7000, 2900, 200, 900],
//     },
//     {
//       label: "Fuel level%",
//     lineTension: 0.3,
//     backgroundColor: "rgba(2,117,216,0.2)",
//     borderColor: "rgba(22,217,816,1)",
//     pointRadius: 5,
//     pointBackgroundColor: "rgba(22,217,816,1)",
//     pointBorderColor: "rgba(255,255,255,0.8)",
//     pointHoverRadius: 5,
//     pointHoverBackgroundColor: "rgba(2,117,216,1)",
//     pointHitRadius: 50,
//     pointBorderWidth: 2,
//     data: [100, 400, 10, 3000, 7000, 500, 5000, 200],
//   },
//   {
//     label: "Engine temperature",
//   lineTension: 0.3,
//   backgroundColor: "rgba(2,117,216,0.2)",
//   borderColor: "rgba(23,27,416,1)",
//   pointRadius: 5,
//   pointBackgroundColor: "rgba(23,27,416,1)",
//   pointBorderColor: "rgba(255,255,255,0.8)",
//   pointHoverRadius: 5,
//   pointHoverBackgroundColor: "rgba(2,117,216,1)",
//   pointHitRadius: 50,
//   pointBorderWidth: 2,
//   data: [3810, 5400, 4060, 3000, 2000, 3900, 6000, 900],
// }],
//       },
//       options: {
//         scales: {
...
// $('#btnRpm-trip4').click(function(event) {
//   // alert("test")
...
//           pointHitRadius: 50,
//           pointBorderWidth: 2,
//           data: [1000, 1020, 1300, 2000, 3000, 3400, 4000, 5000, 6000, 7000, 7200, 7100, 1000],
//         }],
//       },
//       options: {
//         scales: {
